          ...
          <div className="p-5 sm:p-7 lg:p-9">
            ...
            <div className="mt-7 grid gap-4 xl:grid-cols-[1.35fr_.65fr]">
              <div className="rounded-2xl border border-white/[0.08] bg-black/15 p-5">
                <div className="flex items-start justify-between"><div><p className="text-[0.62rem] font-bold tracking-wider text-amber uppercase">MMR Boost · Duo Queue</p><h4 className="mt-2 font-black">Legend III → Ancient I · +500 MMR</h4></div><Badge tone="gold">70% delivered</Badge></div>
                ...
                <div className="mt-2 flex justify-between text-[0.62rem] font-semibold text-mist"><span>350 MMR scope tracked</span><span>70%</span></div>
