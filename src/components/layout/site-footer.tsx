...
const footerLinks = {
  Explore: [["Services", "/services"], ["Coaches", "/coaches"], ["Pricing", "/pricing"], ["Reviews", "/reviews"]],
  ...
  return (
    <footer className="border-t border-white/[0.08] bg-[#060707]">
      <div className="container-shell grid gap-12 py-16 lg:grid-cols-[1.2fr_2fr]">
        <div>
          <Logo />
          <p className="mt-6 max-w-sm text-sm leading-6 text-mist">Private, structured Dota 2 coaching for players who want better decisions—not empty promises.</p>
      ...
      <div className="container-shell flex flex-col gap-3 border-t border-white/[0.07] py-6 text-xs leading-5 text-[#737b78] md:flex-row md:items-center md:justify-between">
        <p>© {new Date().getFullYear()} Highground Coaching. All rights reserved.</p>
