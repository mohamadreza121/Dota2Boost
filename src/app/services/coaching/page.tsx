...
function SectionHeading({
  ...
  return (
    <div className="radiant-section-heading max-w-3xl">
...
export default function CoachingPage() {
  ...
  return (
    <>
      <main className="radiant-academy">
        <section className="radiant-hero">
          <div aria-hidden="true" className="radiant-hero__sun" />
          <div aria-hidden="true" className="radiant-hero__rays" />
          <div aria-hidden="true" className="radiant-hero__canopy" />
          <div aria-hidden="true" className="radiant-hero__ruins" />
          <div aria-hidden="true" className="radiant-hero__mist" />
          <div aria-hidden="true" className="radiant-hero__pollen" />

          <div className="container-shell radiant-hero__layout">
            <div className="radiant-hero__copy">
              <Badge tone="cyan" className="radiant-badge">
                <GraduationCap className="mr-1.5 size-3.5" /> Radiant Academy
              </Badge>
              <h1 className="display-type radiant-hero__title text-balance font-black uppercase">
                <span>Your rank is the symptom.</span>
                <em>We find the cause.</em>
              </h1>
              <p className="radiant-hero__lead mt-7 max-w-3xl text-lg leading-8 text-mist">
              ...
              <p className="radiant-hero__motto mt-5 max-w-2xl text-sm font-semibold leading-7">
            ...
            <aside className="surface radiant-intake p-6">
              <div className="flex items-center justify-between gap-4">
                ...
                <Badge tone="gold" className="radiant-badge">From</Badge>
              </div>
              ...
              <div className="radiant-intake__safety mt-5 flex items-start gap-3 rounded-xl border p-4 text-xs leading-5">
        ...
        <section className="radiant-principles py-8">
          <div className="container-shell grid gap-4 md:grid-cols-3">
            {[
              ...
              return (
                <div key={label as string} className="radiant-principle flex items-center gap-3 text-sm font-bold">
                  <span className="radiant-icon grid size-10 place-items-center rounded-full border">
        ...
        <section className="radiant-zone radiant-zone--diagnosis section-pad">
          <div className="container-shell">
            ...
            <div className="radiant-diagnostic-grid mt-12 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              {diagnosticAreas.map((area) => {
                const Icon = area.icon;
                return (
                  <article key={area.title} className="surface p-5">
                    <span className="radiant-icon grid size-11 place-items-center rounded-full border">
            ...
            <div className="radiant-improvement-map mt-6 grid gap-5 rounded-[1.8rem] border p-6 lg:grid-cols-[.8fr_1.2fr] lg:p-8">
              <div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <div key={item} className="flex items-start gap-3 text-sm leading-6 text-[#dbe6d5]">
        ...
        <section id="academy-programs" className="radiant-band radiant-band--programs py-20 md:py-28">
          <div className="container-shell">
            <SectionHeading
                ...
                return (
                  <article key={program.title} className="surface p-6 sm:p-7">
                    <div className="flex items-start justify-between gap-5">
                      <span className="radiant-icon grid size-12 place-items-center rounded-xl border">
                        <Icon className="size-5" />
                      </span>
                    ...
                    <p className="mt-5 border-l-2 border-[#68e2a0]/40 pl-4 text-xs font-semibold leading-6 text-[#dce7d7]">
                      Best for: {program.bestFor}
                    </p>
                    <ul className="radiant-program-includes mt-6 grid gap-2 sm:grid-cols-3">
                      {program.includes.map((item) => (
                        <li key={item} className="rounded-xl border p-3 text-xs font-semibold">
                          {item}
                        </li>
                      ))}
                    </ul>
        ...
        <section className="radiant-zone radiant-zone--skills section-pad">
          <div className="container-shell">
            <SectionHeading
            ...
            <div className="radiant-skill-tree mt-10">
              {skillBranches.map((branch, index) => {
                const Icon = branch.icon;
                return (
                  <article key={branch.title} className="surface radiant-skill-card rounded-[1.8rem] p-6">
        ...
        <section className="radiant-band radiant-band--journey py-20 md:py-28">
          <div className="container-shell grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
            ...
            <ol className="radiant-journey space-y-4">
              {sessionJourney.map((step, index) => (
                <li
                  key={step.title}
                  className="surface grid gap-4 p-5 sm:grid-cols-[52px_1fr_auto] sm:items-center"
                >
                  <span className="radiant-step-number grid size-11 place-items-center rounded-full border text-xs font-black">
                  ...
                  <ArrowRight className="hidden size-4 text-cyan sm:block" />
                </li>
              ))}
            </ol>
          </div>
        ...
        <section className="radiant-zone radiant-zone--coaches section-pad">
          <div className="container-shell">
            <SectionHeading
            ...
            <div className="mt-12 grid gap-5 lg:grid-cols-[.75fr_1.25fr]">
              <div className="surface radiant-match-panel p-6">
              ...
              <div className="grid gap-5">
                {coachingProfiles.length > 0 ? (
                  coachingProfiles.map((coach) => (
                    <article key={coach.slug} className="surface radiant-coach-card p-6 sm:p-7">
                      <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                        <div className="radiant-coach-seal grid size-20 shrink-0 place-items-center border text-xl font-black">
                          {coach.initials}
                        </div>
                        <div className="min-w-0 flex-1">
                          <div className="flex flex-wrap items-start justify-between gap-4">
                            ...
                            <Badge tone="cyan" className="radiant-badge">{coach.availability}</Badge>
                          </div>
                          ...
                          <div className="mt-5 flex flex-wrap gap-2">
                            {[...coach.roles, ...coach.specialties].map((item) => (
                              <span key={item} className="radiant-tag rounded-full border px-3 py-1.5 text-[0.62rem] font-bold">
                                {item}
                              </span>
                            ))}
                          </div>
                  ...
                  <div className="surface radiant-coach-card p-8">
        ...
        <section className="radiant-band radiant-band--results py-20 md:py-28">
          <div className="container-shell">
            <SectionHeading
            ...
            <div className="radiant-progress-grid mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {progressSignals.map((signal) => (
                <article key={signal.title} className="surface p-5">
                  <div className="flex items-center justify-between gap-4">
            ...
            <div className="radiant-progress-report mt-6 grid gap-5 rounded-[1.8rem] border p-6 lg:grid-cols-[1fr_auto] lg:items-center lg:p-8">
              <div>
                <p className="text-[0.62rem] font-bold tracking-[0.14em] text-cyan uppercase">
                  Every completed plan
                </p>
                <h3 className="mt-3 text-2xl font-black">Leaves you knowing what to practice next.</h3>
                <p className="mt-3 max-w-3xl text-sm leading-7 text-[#dce7d5]">
        ...
        <section className="radiant-zone radiant-zone--paths section-pad">
          <div className="container-shell">
            <SectionHeading
            ...
            <div className="radiant-path-grid mt-12 grid gap-5 lg:grid-cols-3">
              {[
                {
                  label: "01 session",
                ...
                <article key={path.title} className="surface rounded-[1.8rem] p-6">
                  <Badge tone={index === 1 ? "cyan" : "neutral"} className="radiant-badge">{path.label}</Badge>
            ...
            <div className="radiant-price-rail mt-8 flex flex-col items-start justify-between gap-6 rounded-[1.8rem] border p-6 sm:flex-row sm:items-center lg:p-8">
              <div>
        ...
        <section className="radiant-band radiant-band--faq py-20 md:py-28">
          <div className="container-shell grid gap-12 lg:grid-cols-[.7fr_1.3fr]">
            <SectionHeading
            ...
            <div className="radiant-faq-list space-y-3">
              {coachingFaqs.map((item, index) => (
                <details key={item.question} className="surface group p-5">
                  <summary className="flex cursor-pointer list-none items-center gap-4">
                    ...
                    <span className="grid size-7 place-items-center rounded-full border text-lg text-mist transition group-open:rotate-45">
                      +
                    </span>
                  </summary>
        ...
        <section className="radiant-final text-center">
          <div className="container-shell radiant-final__content">
            <Badge tone="cyan" className="radiant-badge">Radiant Academy intake</Badge>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-8">
